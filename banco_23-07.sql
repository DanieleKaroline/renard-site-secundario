...
DROP DATABASE IF EXISTS `renard_site2`;
...
-- Copiando dados para a tabela renard_site2.conteudo: ~19 rows (aproximadamente)
...
-- Copiando dados para a tabela renard_site2.imagem: ~14 rows (aproximadamente)
DELETE FROM `imagem`;
...
-- Copiando dados para a tabela renard_site2.link: ~5 rows (aproximadamente)
DELETE FROM `link`;
...
-- Copiando dados para a tabela renard_site2.plataforma_img: ~4 rows (aproximadamente)
DELETE FROM `plataforma_img`;
