...
-- Copiando estrutura para tabela renard_site2.cursos
CREATE TABLE IF NOT EXISTS `cursos` (
  `codigo` int(3) NOT NULL,
  `curso` varchar(250) NOT NULL,
  `tipo` int(3) NOT NULL,
  `valor` int(4) NOT NULL,
  `instrutor` int(3) NOT NULL,
  PRIMARY KEY (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Copiando dados para a tabela renard_site2.cursos: ~0 rows (aproximadamente)
DELETE FROM `cursos`;
...
INSERT INTO `usuario` (`id`, `nome`, `idade`, `bio`, `cidade`, `endereco`, `email`, `senha`) VALUES
	(3, 'Daniele', '17', 'aaa', 'Hellgistro', 'rua 3, 60', 'carvalho.danielekr@gmail.com', '123');
